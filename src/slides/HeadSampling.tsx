...
export default function HeadSampling() {
  return (
    <SlideFrame
      title="Sampling: head-based"
      notes={
        <>
          <i>Cэмплирование</i> - это механизм, который{' '}
          <b>контролирует объём трейсов</b> - часть трейсов не сохраняется.
          <p>
            Настроить сэмплирование можно в SDK через переменные семплера. Такой
            подход называется <i>Head-based sampling</i>.
          </p>
          <p>
            Здесь решение о том <i>сохранять трейс или нет</i> принимается перед
            его созданием.
          </p>
        </>
      }
