...
export default function Intro() {
  return (
    ...
    >
      ...
      <aside class="notes">
        <p>
          Добрый день! Меня зовут Вячеслав Никулин, я из Freedom Pay. Сегодня
          расскажу об опыте внедрения распределённого трейcинга.
        </p>
        <p>
          Чтобы было понятнее: можно представить, что запрос в системе - это
          посылка. Tracing позволяет отслеживать не только её текущее
          местоположение, но и время на каждой остановке, причины задержек и
