    ...
    <SlideFrame
      ...
      notes={
        <>
          <ul>
            <li>
              Чтобы трейсинг заработал, в первую очередь нужно задать{' '}
              <i>ресурс</i> — это метаданные, о сервисе внутри трейса. Без них
              мы не сможем различить, в каком сервисе был создан спан.
            </li>
            <li>Далее, задаём адрес коллектора.</li>
            <li>
